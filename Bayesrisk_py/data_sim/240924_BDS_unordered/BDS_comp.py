...
from functions_paulibasis_unordered import *
from functions_estimation_unordered import *
...
#MEASUREMENTS
M_b = ['bell', 'pauli_BDS', 'pauli_BDS_un'] # type of measurement
M = [np.arange(1, 31, 1, dtype= int), np.arange(3, 31, 3, dtype= int), np.arange(1, 31, 1, dtype= int)]
