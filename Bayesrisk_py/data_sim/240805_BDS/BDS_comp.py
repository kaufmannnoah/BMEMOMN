...
#MEASUREMENTS
M_b = ['bell', 'pauli_BDS', 'MBU4', 'pauli'] # type of measurement
...
def func(dim, p, m_basis, n_m, r, w0, rho_0, rng= None):    
    ...
    if m_basis == 'bell': rho_recon = recon_from_bell(x)
    if m_basis == 'pauli': rho_recon = recon_from_pauli(x, b)
    if m_basis == 'MUB4': rho_recon = recon_from_MUB4(x, b)
